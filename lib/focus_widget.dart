...
class RectangleModePhoto extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    reactPath.moveTo(size.width / 4, size.height * 3 / 7);
    reactPath.lineTo(size.width / 4, size.height * 4 / 7);
    reactPath.lineTo(size.width * 3 / 4, size.height * 4 / 7);
    reactPath.lineTo(size.width * 3 / 4, size.height * 3 / 7);
